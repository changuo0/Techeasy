...
public class MonkeyLearnClient {
	private static final String API_KEY = "5b094e0e66cc8484845f23cb3b50b1c20550d98f";// make sure change it to your api key.
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		MonkeyLearn ml = new MonkeyLearn("5b094e0e66cc8484845f23cb3b50b1c20550d98f");
	...
	private static List<List<String>> getKeywords(JSONArray mlResultArray) {
		...
		for (int i = 0; i < mlResultArray.size(); ++i) { //for each jobs
			List<String> keywords = new ArrayList<>();
			JSONArray keywordsArray = (JSONArray) mlResultArray.get(i);
			
			for (int j = 0; j < keywordsArray.size(); ++j) { //for each keywords under the job
